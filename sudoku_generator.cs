...
class SudokuGenerator {
    ...
    public SudokuGenerator(string difficulty) {
        ...
        rand = new Random();
        cellsToRemove = difficulty == "easy" ? 35 : difficulty == "medium" ? 45 : 55;
    }
    ...
    public void SaveJSON(string filename) {
        var data = new { puzzle = board, solution = solution, difficulty = "easy" };
    ...
    public static void Main() {
        Console.WriteLine("🧩 Sudoku Generator (Easy) (C#)");
        var gen = new SudokuGenerator("easy");
        gen.Generate();
